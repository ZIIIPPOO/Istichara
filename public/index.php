...
Router::get('User/Resetform', 'UserController', 'resetform');
Router::get('User/Resetpass', 'UserController', 'resetpass');

Router::get('Huissier/signup', 'HuissierController', 'createHuissierWithUser');
Router::get('Avocat/signup', 'HuissierController', 'createHuissierWithUser');
